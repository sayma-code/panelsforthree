    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            @if (Route::has('employee.login'))
                <div class="">
                    @auth('employee')
                        <a href="{{ url('/employee/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Employee Dashboard</a>
                    @else
                        <a href="{{ route('employee.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Employee Log in</a>

                        @if (Route::has('employee.register'))
                            <a href="{{ route('employee.register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Employee Register</a>
                        @endif
                    @endauth
                </div>
            @endif
